//
//  SlidingViewPagerController.swift
//  View Pager
//
...
//MARK: - View Pager Style
enum ViewPagerStyle: String {
    case fixed
    case flexible
}
...
class SlidingViewPagerController: UIViewController {
    ...
    private class HeaderCell: UICollectionViewCell {
        ...
        private func initialHeaderViewSetup(){
            // view
...
extension SlidingViewPagerController: UICollectionViewDelegate{
...
extension SlidingViewPagerController: UICollectionViewDataSource{
...
//MARK: - UI Collection View - Flow Delegate
extension SlidingViewPagerController: UICollectionViewDelegateFlowLayout{
